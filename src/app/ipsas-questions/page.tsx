...
const features = [
  {
    ...
    description:
      "Describe an accounting scenario or standard question in plain language. Upload documentation in PDF. The advisor will identify the relevant IPSAS standards, provide cited guidance, and explain how the treatment applies to your entity's context. If a Customized Client, will apply applicable statutes and regulations for a highly bespoke response.",
    icon: (
