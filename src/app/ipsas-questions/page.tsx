...
// The two things practitioners can do after signing in
const features = [
  {
  ...
  {
    title: "Access Training Modules",
    description:
      "Registered practitioners can also work through the full library of IPSAS training modules — practice questions organised by standard and difficulty level — to build and maintain their technical knowledge.",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="h-8 w-8">
